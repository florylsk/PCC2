              ...
              <Col style={{marginTop:20}}>
                  {
                      <div style={{backgroundColor:"#fff",border:"1px solid #ccc",width:362,height:158}}>
                          <p style={{fontSize:"0.8rem",fontColor:"#444",paddingLeft:10,paddingTop:10}}>With componentsPC premium you can benefit from <span style={{color:"#444",fontWeight:700,fontSize:"0.8rem"}}>FREE</span> shipping fees</p>
