...
class Footer extends React.Component{
    ...
    render() {
        ...
        return(
            <Container style={{backgroundColor:"#ffffff",marginTop:100}}>
                <Navbar>
                    <hr style={{marginLeft:"-50%",position:"absolute",marginTop:-220,marginBottom:90}} width="300%"/>
                        <Col>
                            <Row>
                ...
                <Navbar style={{marginTop:50}}>
                    <hr style={{marginLeft:"-50%",marginTop:-50,position:"absolute"}} width="300%"/>
