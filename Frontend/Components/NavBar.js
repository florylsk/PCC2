...
class NavBar extends React.Component{
    ...
    render() {
        return(
            <Container className="sticky-top" style={{backgroundColor:"#ffffff"}}>
                <Navbar style={{width:10000}}>
                    <Link href="/">
                    ...
                    <Form className="d-flex" style={{marginRight:100,marginTop:20}}>
                ...
                <Navbar>
                    <hr style={{marginLeft:"-50%",position:"absolute",marginBottom:90}} width="300%"/>
                    <Navbar.Collapse>
                        <Nav>
                            <Nav.Link href="#" >
                    ...
                    <hr style={{marginLeft:"-50%",position:"absolute",marginTop:100,marginBottom:90}} width="300%"/>
                </Navbar>
            </Container>
