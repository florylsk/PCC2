                        ...
                        <Col xs={5}>
                            {
                                <div style={{backgroundColor:"#fff",border:"1px solid #ccc",width:362,height:158}}>
                                    <p style={{fontSize:"0.8rem",fontColor:"#444",paddingLeft:10,paddingTop:10}}>We thank you at <span style={{color:"#444",fontWeight:700,fontSize:"0.8rem"}}>ComponentsPC</span> for trusting us and hopefully you enjoy your products!</p>
